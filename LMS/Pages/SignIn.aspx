<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="LMS.Pages.SignIn" %>
            ...
            <div class="screen__content">
                <form id="form1" runat="server" class="login">
                    <div class="login__field">
                        ...
                        <asp:TextBox ID="txtId" Font-Size="Large" CssClass="login__input" Style="width: auto; margin-left: 20px;" AutoCompleteType="Disabled" runat="server" placeholder="Email Id"></asp:TextBox>
                        <br />
                        ...
                        <br />
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtId" ErrorMessage="Please Enter Valid Email ID" Style="font-size: 20px" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                    </div>
                    <div class="login__field">
